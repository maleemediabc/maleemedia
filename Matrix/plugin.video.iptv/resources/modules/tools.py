import os,re,sys,xbmc,json,base64,string,requests,shutil,xbmcplugin,xbmcgui,socket
...
def addDirMeta(name,url,mode,iconimage,fanart,description,year,cast,rating,runtime,genre):
	...
	liz.setProperty("IsPlayable","true")
	cm = []
	cm.append(('Play Trailer','XBMC.RunPlugin(plugin://plugin.video.exodusv3/?mode=9&url='+str(name)+')'))
...
#	xbmcgui.Dialog().yesno(heading, message, [nolabel, yeslabel, autoclose])
	confirm=xbmcgui.Dialog().yesno("Please Confirm","Please Confirm You Wish To Delete Your Kodi Application Cache","Cancel","Delete")
